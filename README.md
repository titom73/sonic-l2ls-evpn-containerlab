...
Just to summarise all the above:

1 - deploy the container lab 

2 - run the script that updates the SONiC JSON

3 - apply the BGP configuration

4 - run the pings to ensure ARP tables are populated
